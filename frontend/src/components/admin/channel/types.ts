...
export function getPlatformTagClass(platform: string): string {
  switch (platform) {
    ...
    case 'deepseek': return 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400'
    ...
    case 'minimax': return 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400'
...
export function getPlatformTextClass(platform: string): string {
  switch (platform) {
    ...
    case 'deepseek': return 'text-yellow-700 dark:text-yellow-400'
    case 'qwen': return 'text-sky-700 dark:text-sky-400'
    case 'zhipu': return 'text-rose-700 dark:text-rose-400'
    case 'minimax': return 'text-indigo-700 dark:text-indigo-400'
    default: return ''
  }
}
